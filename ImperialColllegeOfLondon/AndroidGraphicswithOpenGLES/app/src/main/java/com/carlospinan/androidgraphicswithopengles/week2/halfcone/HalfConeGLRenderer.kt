...
import com.carlospinan.androidgraphicswithopengles.common.objects.HalfCone
...
class HalfConeGLRenderer(
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        halfCone.draw(modelViewProjectionMatrix)
    }
