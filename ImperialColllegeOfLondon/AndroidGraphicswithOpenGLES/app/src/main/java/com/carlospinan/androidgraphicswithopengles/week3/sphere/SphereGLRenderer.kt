...
import com.carlospinan.androidgraphicswithopengles.common.objects.Sphere
...
class SphereGLRenderer(
    ...
    private val lightSphere = floatArrayOf(0F, 0F, 0F)
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        sphere.updateLight(lightSphere)
        sphere.draw(modelViewProjectionMatrix)
    }

    fun updateLightLocation(lightX: Float, lightY: Float, lightZ: Float) {
        lightSphere[0] = lightX
        lightSphere[1] = lightY
        lightSphere[2] = lightZ
    }
