...
import com.carlospinan.androidgraphicswithopengles.common.objects.PentagonPrism
 ...
 * @author Carlos Piñan
 */
class PentagonPrismGLRenderer(
    private val context: Context
) : BaseGLRenderer(context) {

    private lateinit var pentagonPrim: PentagonPrism
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        pentagonPrim = PentagonPrism(context)
    }
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        // Matrix.rotateM(rotationMatrix, 0, angle++, 0F, 1F, 0F)
        ...
        pentagonPrim.draw(modelViewProjectionMatrix)
    }
