...
import com.carlospinan.androidgraphicswithopengles.common.objects.letters.LetterV
 ...
 * @author Carlos Piñan
 */
class LetterVGLRenderer(
    private val context: Context
) : BaseGLRenderer(context) {

    private lateinit var letterV: LetterV
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        letterV.draw(modelViewProjectionMatrix)
    }
