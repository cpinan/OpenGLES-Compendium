...
class LetterS(
    ...
    override fun setUp() {
        var vertex = FloatArray(65535)
        var colors = FloatArray(65535)
        var indices = IntArray(65535)
        ...
        vertex = vertex.copyOf(k)
        colors = colors.copyOf(colorIndex)
        indices = indices.copyOf(index)
