...
class SphereLightGLSurfaceView(
    context: Context
    ...
    private lateinit var customRenderer: SphereLightGLRenderer
    ...
    override fun setupRenderer(): BaseGLRenderer {
        return SphereLightGLRenderer(context)
    }
    ...
    override fun additionalSetup() {
        ...
        customRenderer = renderer as SphereLightGLRenderer
    }
    ...
    private fun updateOrientation(rotationVector: FloatArray) {
        ...
        val yaw = orientation[0] * radianToDegree
        val pitch = orientation[1] * radianToDegree
        val roll = orientation[2] * radianToDegree
